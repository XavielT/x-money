...
export const BANKS_MOCK: BankModel[] = [
  ...
  { id: 'billet', name: 'Billet', short: 'Bt', color: '#5cb82f', textColor: '#ffffff', logo: 'banks/billet.png' },
  { id: 'tpago', name: 'tPago', short: 'tP', color: '#7b3f9e', textColor: '#ffffff', logo: 'banks/tpago.png' },
  { id: 'vimencash', name: 'VimenCash', short: 'VC', color: '#003f8c', textColor: '#ffffff', logo: 'banks/vimencash.png' },
